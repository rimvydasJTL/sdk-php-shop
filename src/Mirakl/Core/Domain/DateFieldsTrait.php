...
trait DateFieldsTrait
{
    ...
    protected static $dateFields = [
        'acceptance_decision_date', 'accounting_document_creation_date', 'api', 'api_date', 'approval_creation_date', 'available_end_date',
        'available_start_date', 'billing_cycle_from', 'billing_cycle_to', 'birth_date', 'bo', 'bo_date',
        'closed_from', 'closed_from_date', 'closed_to', 'closed_to_date', 'created_date', 'created_since',
        'creation', 'creation_date', 'customer_debited_date', 'cut_off_next_date', 'date', 'date_created',
        'date_created_from', 'date_created_to', 'date_deleted', 'date_from', 'date_to', 'date_updated',
        'date_uploaded', 'debited_date', 'deleted_from', 'deleted_to', 'deletion_date', 'discount_end_date',
        'discount_start_date', 'due_date', 'earliest', 'earliest_delivery_date', 'emission_date', 'end_date',
        'end_refund_creation_date', 'end_update_date', 'ending_after', 'expiration_date', 'immunity_date', 'immunized_until',
